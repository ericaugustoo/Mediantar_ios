...
class Paginabrams7 extends StatefulWidget {
  @override
  _Paginabrams7State createState() => _Paginabrams7State();
}

class _Paginabrams7State extends State<Paginabrams7> {
  @override
    ...
    var size = MediaQuery.of(context).size;
      ...
      body: SingleChildScrollView( 
        ...
        child: Column(
          ...
          BotaoResposta('Nada', coresbotao[60], () => onclick(60, 64, 60)),
              Divider( height: size.height * 0.015 , thickness: 0.0, color: Colors.transparent ),
           BotaoResposta('Um pouco', coresbotao[61], () => onclick(60, 64, 61)),
              Divider( height: size.height * 0.015 , thickness: 0.0, color: Colors.transparent ),
           BotaoResposta('Moderadamente',coresbotao[62], () => onclick(60, 64, 62)),
              Divider( height: size.height * 0.015 , thickness: 0.0, color: Colors.transparent ),
           BotaoResposta('Bastante', coresbotao[63], () => onclick(60, 64, 63)),
              Divider( height: size.height * 0.015 , thickness: 0.0, color: Colors.transparent ),
           BotaoResposta('Extremamente', coresbotao[64], () => onclick(60, 64, 64)),
              Divider( height: size.height * 0.015 , thickness: 0.0, color: Colors.transparent ),
              
            Sentimento('PREOCUPADO'),
          
            Divider( height: size.height * 0.015 , thickness: 0.0, color: Colors.transparent ),
           BotaoResposta('Nada', coresbotao[65], () => onclick(65, 69, 65)),
              Divider( height: size.height * 0.015 , thickness: 0.0, color: Colors.transparent ),
          BotaoResposta('Um pouco', coresbotao[66], () => onclick(65, 69, 66)),
              Divider( height: size.height * 0.015 , thickness: 0.0, color: Colors.transparent ),
          BotaoResposta('Moderadamente',coresbotao[67], () => onclick(65, 69, 67)),
              Divider( height: size.height * 0.015 , thickness: 0.0, color: Colors.transparent ),
          BotaoResposta('Bastante', coresbotao[68], () => onclick(65, 69, 68)),
              Divider( height: size.height * 0.015 , thickness: 0.0, color: Colors.transparent ),
          BotaoResposta('Extremamente', coresbotao[69], () => onclick(65, 69, 69)),
            ...
            //é possível saber qual a resposta assinalada
              ...
              nextpage() {
                ...
                for (int i = 65; i < 70; i++) {
                  ...
                  if ((v1 && v2) == true ) {
                   Navigator.pushNamed(context, "/pagebrams8");
                  }
                  else {
                    showCupertinoDialog(
                    context: context,
