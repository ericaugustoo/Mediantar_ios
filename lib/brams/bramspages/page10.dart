...
class Paginabrams10 extends StatefulWidget {
  @override
  _Paginabrams10State createState() => _Paginabrams10State();
}

class _Paginabrams10State extends State<Paginabrams10> {
  @override
    ...
    var size = MediaQuery.of(context).size;
      ...
      body: SingleChildScrollView( 
        ...
        child: Column(
          ...
          BotaoResposta('Nada', coresbotao[90], () => onclick(90, 94, 90)),
              Divider( height: size.height * 0.015 , thickness: 0.0, color: Colors.transparent ),
           BotaoResposta('Um pouco', coresbotao[91], () => onclick(90, 94, 91)),
              Divider( height: size.height * 0.015 , thickness: 0.0, color: Colors.transparent ),
           BotaoResposta('Moderadamente',coresbotao[92], () => onclick(90, 94, 92)),
              Divider( height: size.height * 0.015 , thickness: 0.0, color: Colors.transparent ),
           BotaoResposta('Bastante', coresbotao[93], () => onclick(90, 94, 93)),
              Divider( height: size.height * 0.015 , thickness: 0.0, color: Colors.transparent ),
           BotaoResposta('Extremamente', coresbotao[94], () => onclick(90, 94, 94)),
              Divider( height: size.height * 0.015 , thickness: 0.0, color: Colors.transparent ),
              
            Sentimento('COM ENERGIA'),
          
            Divider( height: size.height * 0.015 , thickness: 0.0, color: Colors.transparent ),
           BotaoResposta('Nada', coresbotao[95], () => onclick(95, 99, 95)),
              Divider( height: size.height * 0.015 , thickness: 0.0, color: Colors.transparent ),
          BotaoResposta('Um pouco', coresbotao[96], () => onclick(95, 99, 96)),
              Divider( height: size.height * 0.015 , thickness: 0.0, color: Colors.transparent ),
          BotaoResposta('Moderadamente',coresbotao[97], () => onclick(95, 99, 97)),
              Divider( height: size.height * 0.015 , thickness: 0.0, color: Colors.transparent ),
          BotaoResposta('Bastante', coresbotao[98], () => onclick(95, 99, 98)),
              Divider( height: size.height * 0.015 , thickness: 0.0, color: Colors.transparent ),
          BotaoResposta('Extremamente', coresbotao[99], () => onclick(95, 99, 99)),
            ...
            //é possível saber qual a resposta assinalada
              ...
              nextpage() {
                ...
                for (int i = 95; i < 100; i++) {
                  ...
                  if ((v1 && v2) == true ) {
                   Navigator.pushNamed(context, "/pagebrams11");
                  }
                  else {
                    showCupertinoDialog(
                    context: context,
